...
**A headless, tokenized design system and methodology for starting every client design system from the same place.**
...
| | |
|---|---|
| Role | Design System Designer and System Advocate |
| Year | 2023 |
| Duration | 18 months |
| Client | Internal system for Hide and Seek Digital |
...
**Card 1**
- Icon: a book or documentation symbol
...
**Card 2**
- Icon: a flowchart or branching diagram
...
Designing the system was the smaller half of the work. Getting it adopted was the harder half.
...
**Prominent line:** HASTE became the foundation for new client engagements during my time at the agency.

**Supporting context:** Used on projects including the Australian Federal Police and Relate. The system, the handbook, the recorded training, and the workflow diagrams remained as the agency's starting kit when I transitioned out. Day-to-day stewardship moved to the team. Working on Relate as an interaction designer, I experienced HASTE from the consumer side: the foundation made room for brand-specific components rather than basic ones, which is exactly the value the system was designed to deliver.
...
- What HASTE was for → `#what-haste-was-for`
- The system → `#the-system`
- The methodology → `#the-methodology`
- What I learned about adoption → `#adoption`
- Where the architecture had a cost → `#architectural-cost`
- Outcome → `#outcome`
- What HASTE taught me → `#reflection`
