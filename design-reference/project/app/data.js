...
const CASE_STUDIES = [
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'pullQuote', text: 'The richer the brand expression you want to enable structurally, the more layers the system needs to expose.' },
      ...
      {
        id: 'reflection',
        label: 'What I take into multi-brand work',
  ...
  // outcomeCallout closes the body. Backup in data.relate-haste-backup.js.
  {
    ...
    quickContext: {
      body: '<strong>A full-spectrum engagement covering brand identity, design system, product UI, and marketing site for an enterprise AI product.</strong> Six months, five-timezone distributed team. The product launched and is in active use, with the client now in funding rounds to scale.'
    },
    sections: [
      {
        id: 'brief',
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'pullQuote', text: 'The brand can carry the energy. The interface should carry the work.' }
        ]
      },
      {
        id: 'outcome',
      ...
      {
        id: 'reflection',
        label: 'What I take into AI product work',
        title: 'What I take into AI product work now',
        body: [
          { type: 'p', text: 'The reflection from Relate is one I now treat as a working principle: <strong>express intent with less.</strong>' },
