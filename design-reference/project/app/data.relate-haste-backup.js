...
const CASE_STUDIES = [
  ...
  // Backup of the prior TWE content lives in app/data.twe-backup.js.
  {
    ...
    factsPanel: [
      ...
      { label: 'Client', value: 'Treasury Wine Estates' },
  ...
  // Backup of the previous Trier content lives in app/data.trier-backup.js.
  {
    ...
    factsPanel: [
      ...
      { label: 'Year', value: '2023 to 2024' },
      { label: 'Client', value: 'Trier Medical Solutions, in collaboration with Imminently' },
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'figure', caption: 'Accessibility-led patterns — enlarged tap targets, type sizes, and form controls calibrated for older patients.' }
        ]
      },
      {
        ...
        body: [
          ...
          { type: 'figure', caption: 'Clinician web app — a single-screen triage view consolidating patient data, observations, and prioritization.' }
        ]
      },
      {
        id: 'outcome',
        ...
        body: [
          ...
          // Video placeholder — Onur will paste a Vimeo or YouTube
          // link into `src` later (e.g. 'https://www.youtube.com/watch?v=...').
          { type: 'video', src: null, caption: '9News Perth segment — clinicians from Sir Charles Gairdner Hospital discuss the new triage workflow.' }
        ]
      },
      {
        id: 'reflection',
